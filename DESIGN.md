...
- **`src/components/LearningHub.tsx`**: Houses the Academy, containing course syllabi, progress bars matching the updated 4-module bootcamp limit, and dynamic module drawers.
